...
ENGINE_A = ROOT / "model/cuda_bevformer/build/camera.backbone_fpn.dcnv2.fp32.im2colgemm.plan"
...
ENGINE_D = ROOT / "model/mapdiffusion_routeA/build/stream_fusion_neck.fp32.plan"
...
def main():
    ...
    # C: bev_features + query_coords + timestep -> line_preds/cls_logits
