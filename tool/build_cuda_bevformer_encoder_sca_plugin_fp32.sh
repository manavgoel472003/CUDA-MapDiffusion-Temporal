...
ONNX=$base/camera.bevformer_encoder.sca_plugin.msda_trt.onnx
PLAN=$base/build/camera.bevformer_encoder.sca_plugin.msda_trt.fp32.plan
LOG=$base/build/camera.bevformer_encoder.sca_plugin.msda_trt.fp32.log
