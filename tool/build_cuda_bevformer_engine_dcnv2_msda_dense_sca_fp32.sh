...
PLAN=$base/build/camera.bevformer.dcnv2.msda_trt.dense_sca.fp32.plan
LOG=$base/build/camera.bevformer.dcnv2.msda_trt.dense_sca.fp32.log
JSON=$base/build/camera.bevformer.dcnv2.msda_trt.dense_sca.fp32.json
