...
OUT_DIR = "/home/018198687/Mapping/Lidar_AI_Solution/CUDA-BEVFusion/model/cuda_bevformer/parity_engine_b_full"
...
def main():
    ...
    for name, tensor in zip(["feat0", "feat1", "feat2"], feats):
    ...
    np.save(os.path.join(OUT_DIR, "pytorch_bev_full.npy"), ref)
