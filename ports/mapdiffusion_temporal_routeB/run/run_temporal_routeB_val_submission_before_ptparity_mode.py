...
def main():
    ...
    for count_i, dataset_idx in enumerate(indices):
        ...
        # PyTorch first frame feeds raw B BEV into the head; it does NOT use
        # stream-fused D output when no temporal BEV history exists.
        if scene_is_first_frame:
        ...
        # Keep fused_bev variable for state/debug compatibility.
        fused_bev = head_bev
        ...
        for step_i, t in enumerate(timesteps[:-1]):
            ...
            C_run = C_first if scene_is_first_frame else C
